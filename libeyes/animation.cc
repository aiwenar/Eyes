...
void animation::registerAnimations ( QMap <QString,animation*> * map )
{
    ...
    map->insert ( "cusual_01_open", ( new animation ( 4 ) )->add_frame ( "clap_06" )->add_frame ( "clap_07" )->add_frame("clap_08")->add_frame("clap_09") );
    ...
    map->insert ( "bul_01_open", ( new animation ( 4 ) )->add_frame ( "clap_06" )->add_frame ( "clap_07" )->add_frame("clap_08")->add_frame("clap_09") );
    ...
    map->insert ( "bul_02_open", ( new animation ( 4 ) )->add_frame ( "clap_06" )->add_frame ( "clap_07" )->add_frame("clap_08")->add_frame("clap_09") );
    ...
    map->insert ( "bul_03_open", ( new animation ( 4 ) )->add_frame ( "clap_06" )->add_frame ( "clap_07" )->add_frame("clap_08")->add_frame("clap_09") );
    ...
    map->insert ( "bul_04_open", ( new animation ( 4 ) )->add_frame ( "clap_06" )->add_frame ( "clap_07" )->add_frame("clap_08")->add_frame("clap_09") );
    map->insert ( "bul_05_close", ( new animation ( 4 ) )->add_frame ("clap_02")->add_frame ( "clap_03" )->add_frame ( "clap_04" )->add_frame ( "clap_05" ) );
    map->insert ( "bul_05_open", ( new animation ( 3 ) )->add_frame ( "clap_06" )->add_frame ( "clap_07" )->add_frame("clap_08") );
    map->insert ( "bul_06_close", ( new animation ( 4 ) )->add_frame ("clap_02")->add_frame ( "clap_03" )->add_frame ( "clap_04" )->add_frame ( "clap_05" ) );
    map->insert ( "bul_06_open", ( new animation ( 3 ) )->add_frame ( "clap_06" )->add_frame ( "clap_07" )->add_frame("clap_08") );
    map->insert ( "bul_07_close", ( new animation ( 4 ) )->add_frame ("clap_02")->add_frame ( "clap_03" )->add_frame ( "clap_04" )->add_frame ( "clap_05" ) );
    map->insert ( "bul_07_open", ( new animation ( 3 ) )->add_frame ( "clap_06" )->add_frame ( "clap_07" )->add_frame("clap_08") );
    map->insert ( "bul_08_close", ( new animation ( 4 ) )->add_frame ("clap_02")->add_frame ( "clap_03" )->add_frame ( "clap_04" )->add_frame ( "clap_05" ) );
    map->insert ( "bul_08_open", ( new animation ( 3 ) )->add_frame ( "clap_06" )->add_frame ( "clap_07" )->add_frame("clap_08") );
    ...
    map->insert ( "bul_09_open", ( new animation ( 5 ) )->add_frame ( "bclap_07" )->add_frame ( "bclap_08" )->add_frame("bclap_09")->add_frame("bclap_10")->add_frame("bclap_11") );
    ...
    map->insert ( "bul_10_open", ( new animation ( 5 ) )->add_frame ( "bclap_07" )->add_frame ( "bclap_08" )->add_frame("bclap_09")->add_frame("bclap_10")->add_frame("bclap_11") );
    ...
    map->insert ( "bul_11_open", ( new animation ( 5 ) )->add_frame ( "bclap_07" )->add_frame ( "bclap_08" )->add_frame("bclap_09")->add_frame("bclap_10")->add_frame("bclap_11") );
    ...
    map->insert ( "bul_12_open", ( new animation ( 5 ) )->add_frame ( "bhclap_07" )->add_frame ( "bhclap_08" )->add_frame("bhclap_09")->add_frame("bhclap_10")->add_frame("bhclap_11") );
    ...
    map->insert ( "bul_13_open", ( new animation ( 5 ) )->add_frame ( "bhclap_07" )->add_frame ( "bhclap_08" )->add_frame("bhclap_09")->add_frame("bhclap_10")->add_frame("bhclap_11") );
    ...
    map->insert ( "bul_14_open", ( new animation ( 5 ) )->add_frame ( "bhclap_07" )->add_frame ( "bhclap_08" )->add_frame("bhclap_09")->add_frame("bhclap_10")->add_frame("bhclap_11") );
    ...
    map->insert ( "bul_15_open", ( new animation ( 5 ) )->add_frame ( "bhclap_07" )->add_frame ( "bhclap_08" )->add_frame("bhclap_09")->add_frame("bhclap_10")->add_frame("bhclap_11") );
    ...
    map->insert ( "sh_02_open", ( new animation ( 7 ) )->add_frame ("clap_06")->add_frame("clap_07")->add_frame("clap_08")->add_frame("clap_09")->add_frame("cusual_01")->add_frame("sh_02")->add_frame("sh_01") );
